...
<head>
    <meta charset="utf-8">
    <title>Hospital SignUp | Cure Near You - The Healthcare Assistance</title>
            ...
            <div class="row gx-5">
                ...
                <div class="col-lg-6">
                    <div class="bg-light text-center rounded p-5">
                        <h1 class="mb-4">Hospital SignUp</h1>
                        <form action="HospitalSignUp" method="post">
                            <div class="row g-3">
                                <div class="col-12 col-sm-12">
                                    ...
                                    <div class="nav-item dropdown">
                                		...
                                		<a href="./hospitalsignup.jsp" class="dropdown-item">Hospital</a>
...
<%@include file="hospitalfooter.jsp" %>
</body>
</html>